...
### Fixed
- Rapid facing slider drag no longer crashes the app; debounced `history.replaceState` to prevent browser SecurityError from rate-limit (>100 calls/30s)

## [0.6.1] - 2026-04-27

### Changed
- Search/lat-lon toggle buttons now match in style (zinc, no green)
- lat/lon input fields commit on Enter key and blur
- Input focus ring changed from emerald to zinc
